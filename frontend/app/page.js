        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-2xl font-bold text-white tracking-tight">📱 School SMS Broadcast</h1>
                <p className="text-sm text-blue-100">Send announcements to parents and students instantly</p>
              </div>
            </div>
            <div className="flex items-center space-x-3">
